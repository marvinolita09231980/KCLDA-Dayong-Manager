...
public sealed class LanSyncSnapshot
{
	public List<LanSyncMember> Members { get; set; } = new();
	public List<LanSyncCycle> Cycles { get; set; } = new();
	public List<LanSyncPayment> Payments { get; set; } = new();
}
